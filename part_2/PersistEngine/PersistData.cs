...
namespace Project4Starter
{
    ...
    public class PersistData<Key, Value>
    {
        ...
        */
        ...
        public bool restoreDataToXML(string filename,DBEngine<string, DBElement<string, List<string>>> dbl)
        {
            XDocument xml = new XDocument();
            xml.Declaration = new XDeclaration("1.0", "utf-8", "yes");
            XComment xmlComment = new XComment("XML document of type string-List<string>");
            xml.Add(xmlComment);
            XElement root = new XElement("noSqlDb");
            xml.Add(root);
            ...
            payloadType.SetValue("List<String>");
            root.Add(keyType);
